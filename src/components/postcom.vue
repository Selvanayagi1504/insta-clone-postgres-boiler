...
<script>
    export default {
        ...
        mounted() {
            ...
            fetch("https://evening-reef-11191.herokuapp.com/api/user/getuser/" + email,{headers: {"x-access-token": localStorage.getItem("token")}})
            ...
            let pa=[]
            fetch("https://evening-reef-11191.herokuapp.com/api/user/getuser/" + postuemail,{headers: {"x-access-token": localStorage.getItem("token")}})
            .then(response => response.json())
            .then(user => {
        ...
        methods: {
            saveucom(img, email) {
                ...
                fetch("https://evening-reef-11191.herokuapp.com/api/user/changepost/" + email, {
                        method: "POST",
                        body: JSON.stringify(
                            newposts
                        ),
